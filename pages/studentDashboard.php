	...
	<div class="container">
		...
		<div class="row">
			...
			?>
				...
				?>
				<!-- Modal -->
				<div class="modal fade <?php echo $eventDetail['event_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $eventDetail['event_id'] ?>" aria-hidden="true">
							...
							<div class="modal-body">
								<div>
									<div style="margin: 12px; text-align: center;">
										<img src="<?php echo '../' . $eventDetail['image'] ?>" alt="" srcset="" width="270px" height="170px" style="margin: 22px;">
				...
				<div class="col-md-12">
					<div data-toggle="modal" data-target=".<?php echo $eventDetail['event_id'] ?>" class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
						...
						<div class="single-schedule-tumb-info d-flex align-items-center">
							...
							<div class="single-schedule-info">
								<h6><?php echo $eventDetail['event_name'] ?></h6>
								<p>Cordinators,
									<br />
									<?php $coordinators = explode("|", $eventDetail['event_cordinators']);
									foreach ($coordinators as $letter => $index) {
						...
						<div class="schedule-time-place">
							<p><i class="zmdi zmdi-time"></i><?php echo $eventDetail['event_date'] ?> | <?php echo $eventDetail['event_time'] ?></p>
							<p><i class="zmdi zmdi-map"></i> <?php echo $eventDetail['event_venue'] ?></p>
						</div>
