...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2023 at 10:20 PM
...
('TECH QUEST CHALLENGE', 9, '26/09/23', '03:30 PM to 04:30 PM', 'Sir. C. V. Raman Auditorium', 4, 0, 0, 0, 4, 'COMMON', 'public/images/event/treasure-hunt.avif', 'Off Stage', 'It is team event. This event is for both boys and girls teams. Participants count : Maximum 4 members. Time limit : 1 hour. Detailed rules will be announced by organizers.', 'Mr. K.KIRUBAKARAN|Mr.A.VENNIMALAIRAJAN'),
...
('WARRIOR\'S SHOWCASE', 13, '27/09/23', '09:45 AM – 10:45 AM', 'PlayGround', 2, 0, 0, 0, 2, 'BOYS', 'public/images/event/martial-arts.webp', 'Off Stage', 'This is a team event exclusively for boys teams, with each team consisting of 2 members. The allotted time limit for the performance is 5 minutes. Participants are responsible for bringing all the necessary materials. The performance can encompass various activities such as Yoga, Karate, Silambam, Karali, Kattas, or Taekwondo movements. However, it\'s important to note that the use of fire and glass is strictly prohibited for safety reasons.', 'Mr.K.SUNDARARAJAN|Mr.P.SELVAKUMAR'),
('PICASSO ON FACE', 14, '27/09/23', '11:00 AM to 12:00 PM', 'Ohm’s Lab', 4, 1, 2, 2, 4, 'BOYS', 'public/images/event/face-painting.avif', 'Off Stage', 'It is team event. This event is for boys teams only. Participants count : 2 groups/ team with 2 members in each group. Time limit : 1 hour. The participants should bring all necessary materials. Theme will be given on the spot.', 'Dr.R.ATHILINGAM|Mrs.M.KANIMOZHI\r\n'),
