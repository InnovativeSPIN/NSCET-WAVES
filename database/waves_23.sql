...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2023 at 08:31 PM
...
('WARRIOR\'S SHOWCASE', 13, '27/09/23', '09:45 AM – 10-45 AM', 'PlayGround', 2, 1, 1, 2, 2, 'BOYS', 'public/images/event/martial-arts.webp', 'Off Stage', 'This is a team event exclusively for boys teams, with each team consisting of 2 members. The allotted time limit for the performance is 5 minutes. Participants are responsible for bringing all the necessary materials. The performance can encompass various activities such as Yoga, Karate, Silambam, Karali, Kattas, or Taekwondo movements. However, it\'s important to note that the use of fire and glass is strictly prohibited for safety reasons.', 'Mr.K.SUNDARARAJAN|Mr.P.SELVAKUMAR'),
