...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Sep 11, 2023 at 06:04 PM
...
INSERT INTO `admindb` (`name`, `dept`, `role`, `reg_no`, `password`, `event_name`, `house_name`) VALUES
('MUKILAN', 'CSE', 'team captain', '008', '$2y$10$RSJBIjpEKAvXdbkvL2B9YeFreevQR2vnqsmBjRUymBeluCnR7b2lm', '-', 'TIGER THRASHERS'),
('TENSHKUMAR K', 'CSE', 'team captain', '921021104051', '$2y$10$klxxEAi3EJUloMfexhz4qu3eEo4oDhbhOIovEJicg9mveaK9JC9li', '-', 'TIGER THRASHERS');
...
('CARBON ART', 1, '26/09/23', '09:45 AM – 10-45 AM', 'Chemistry Lab', 2, 0, 0, 0, 2, 'COMMON', 'public/images/event/carbonart.jpg', 'Off Stage', 'It is solo event. This event is for both boys and girls teams. Participants count : 2 per team. Time limit : 1 hour. The topic will be given on the spot.', 'MUKILAN | TENSH KUMAR'),
('CINE SNAP', 2, '26/09/23', '09:45 AM – 10:45 AM', 'Physics Lab', 10, 0, 0, 0, 10, 'COMMON', 'public/images/event/cine.jpg', 'Off Stage', '!', NULL),
('PICASSO ON GLASS', 3, '26/09/23', '11:00 AM to 11:45 AM', 'Chemistry Lab', 4, 1, 2, 2, 4, 'COMMON', 'public/images/event/glasspicaso.jpg', 'Off Stage', 'It is team event. This event is for both boys and girls teams. Participants count : 2 groups/ team with 2 members in each group. Time limit : 1 hour. The participants should bring all necessary materials.', NULL),
('INSTAREEL RIVALS', 4, '26/09/23', '11:15 AM', ' ', 1, 0, 0, 0, 1, 'COMMON', 'public/images/event/reels.png', 'Off Stage', '!', NULL),
('ARTY CRAFTY', 5, '26/09/23', '12:00 PM to 01:00 PM', 'Ohm’s Lab', 4, 1, 2, 2, 4, 'COMMON', 'public/images/event/ARTYCRAFTY.png', 'Off Stage', 'It is team event This event is for both boys and girls teams. Participants count : 2 groups/ team with 2 members in each group. Time limit : 1 hour. The participants should bring necessary materials. Only waste materials should be used', NULL),
('TALK ON THE SPOT', 6, '26/09/23', '01:00 PM to 02:00 PM', 'Language Lab', 4, 1, 2, 2, 4, 'COMMON', 'public/images/event/talk.jpg', 'Off Stage', 'It is solo event. This event is for both boys and girls teams. Participants count : 2 per team. Time limit : 2 minutes for preparation, 3 minutes for performance. The topic will be given on the spot. Judgment will be based on relevance to the title, fluen', NULL),
('BLOSSOM & CRAFTS', 7, '26/09/23', '02:00 PM to 03:00 PM', 'Chemistry Lab', 4, 1, 2, 2, 4, 'COMMON', 'public/images/event/several-colorful-gifts-with-bow.jpg', 'Off Stage', 'It is team event. This event is for both boys and girls teams. Participants count : 2 groups/ team with 2 members in each group. Time limit : 1 hour. The participants should bring all necessary materials. The art may be floral or any gift and it depends o', NULL),
('CUISINE MASTER', 8, '26/09/23', '03:15 PM to 04:15 PM', 'Physics Lab', 6, 1, 2, 3, 6, 'COMMON', 'public/images/event/cuisine_master.jpg', 'Off Stage', 'It is team event. This event is for Girls teams only. Participants count : 2 groups/ team with 3 members in each group. Time limit : 1 hour. The participants should bring all necessary materials. Results will be based on taste and creativity. Participants', NULL),
('TECH QUEST CHALLENGE', 9, '26/09/23', '03:30 PM to 04:30 PM', 'Sir. C. V. Raman Auditorium', 4, 1, 1, 4, 4, 'COMMON', 'public/images/event/treasure-hunt.avif', 'Off Stage', 'It is team event. This event is for both boys and girls teams. Participants count : Maximum 4 members. Time limit : 1 hour. Detailed rules will be announced by organizers.', NULL),
('HANDY HENNA', 10, '27/09/23', '09:45 AM – 10-45 AM', 'Chemistry Lab', 4, 1, 2, 2, 4, 'GIRLS', 'public/images/event/henna.avif', 'Off Stage', 'It is team event. This event is for Girls teams only. Participants count : 2 groups/ team with 2 members in each group. Time limit : 1 hour. The participants should bring all necessary materials.', NULL),
('HAIRY DORA', 11, '27/09/23', '11:00 AM to 12:00 noon', 'Physics Lab', 4, 1, 2, 2, 4, 'GIRLS', 'public/images/event/hairy.jpg', 'Off Stage', 'It is team event. This event is for Girls teams only. Participants count : 2 groups/ team with 2 members in each group. Time limit : 1 hour. The participants should bring all necessary materials.', NULL),
('ODYSSEY ENGLISH', 12, '27/09/23', '12:15 PM to 01:15 PM', 'Ohm’s Lab', 7, 0, 0, 0, 7, 'GIRLS', 'public/images/event/webpage 3.jpg', 'Off Stage', '!', NULL),
('WARRIOR\'S SHOWCASE', 13, '27/09/23', '09:45 AM – 10-45 AM', 'PlayGround', 2, 1, 1, 2, 2, 'BOYS', 'public/images/event/martial-arts.webp', 'Off Stage', 'It is team event. This event is for boys teams only. Participants count : 2 members in each Team. Time limit : 5 minutes. The participants should bring all necessary materials. The performance may be Yoga, Karate, silambam, karali, kattas, takewan-do mov', NULL),
...
('GAMER\'S GAUNTLET', 15, '27/09/23', '12:15 PM to 01:15 PM', 'Dennis Lab', 5, 0, 0, 0, 5, 'BOYS', 'public/images/event/cod.jpg', 'Off Stage', '!', NULL),
('CARVO', 16, '27/09/23', '02:00 PM to 03:00 PM', 'Ohm’s Lab', 6, 1, 2, 3, 6, 'COMMON', 'public/images/event/carvo.jpg', 'Off Stage', 'It is team event. This event is for both boys and girls teams. Participants count : 2 groups/ team with 3 members in each group. Time limit : 1 hour. The participants should bring all necessary materials.', NULL),
