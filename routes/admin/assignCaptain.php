...
if (isset($_POST["submit"])) {
    ...
    $incharge_name_3 = mysqli_real_escape_string($conn, $_POST["incharge_name_3"]);
    ...
    $staff_dept_3 = mysqli_real_escape_string($conn, $_POST["staff_dept_3"]);
    ...
    $query5 = "INSERT INTO `admindb`(`name`, `dept`, `reg_no`, `role`, `password`, `event_name`, `house_name`) VALUES ('$incharge_name_3','$staff_dept_3','-','team incharge','$hashed_password','-','$house_name')";
    ...
    if (mysqli_query($conn, $query1) && mysqli_query($conn, $query2) && mysqli_query($conn, $query5) && mysqli_query($conn, $query3) && mysqli_query($conn, $query4)) {
